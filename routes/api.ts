...
api.get(
  ...
  async (req, res, next) => {
    ...
    try {
      const collections = await factory.mongoManager.getCollectionsJson(
        server,
        database
      );
...
api.get(
  "/servers/:server/databases/:database/collections/:collection/query",
  async (req, res, next) => {
    const server = req.params.server;
    const database = req.params.database;
    const collection = req.params.collection;
...
api.get(
  "/servers/:server/databases/:database/collections/:collection/count",
  async (req, res, next) => {
    const server = req.params.server;
    const database = req.params.database;
    const collection = req.params.collection;
